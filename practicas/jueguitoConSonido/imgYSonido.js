...
function bloquearTarjetas() {
  for (let i = 0; i <= 15; i++) {
    ...
    tarjetaBloqueada.innerHTML = `<img src="./images/${numeros[i]}.png" alt="foto">`
...
function destapar(id) {
  ...
  if (tarjetasDestapadas === 1) {
    ...
    tarjeta.innerHTML = `<img src="./images/${primerResultado}.png" alt="foto">`
    clickAudio.play()
    ...
    tarjeta2.innerHTML = `<img src="./images/${segundoResultado}.png" alt="foto">`
